...
export function StatusGraph({ transactions, title = "Visibility Distribution", description = "Transactions by visibility" }: StatusGraphProps) {
    ...
    <Card className="flex flex-col bg-gradient-to-br from-fuchsia-50/50 via-white to-pink-50/50 dark:from-fuchsia-950/20 dark:via-background dark:to-pink-950/20 border-fuchsia-200/50 dark:border-fuchsia-800/30">
      ...
      <CardContent className="p-2">
        {totalCount === 0 ? (
          ...
          <ChartContainer config={chartConfig} className="w-full h-[200px] sm:h-[250px] lg:h-[160px] bg-gradient-to-br from-fuchsia-50/80 to-pink-50/80 dark:from-fuchsia-950/40 dark:to-pink-950/40 rounded-lg">
      ...
      <CardFooter><div className="flex w-full items-center justify-center text-xs sm:text-sm text-muted-foreground">Public vs Private transactions</div></CardFooter>
    </Card>
  );
}
