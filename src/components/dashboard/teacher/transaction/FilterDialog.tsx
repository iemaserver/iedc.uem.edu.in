...
export function FilterDialog({ filters, onFiltersChange, visibilityOptions = ["public", "private"] }: FilterDialogProps) {
  ...
  const handleClear = () => {
    const cleared = { dateRange: { from: "", to: "" }, visibility: "all", authorCount: "all", status: "all" };
      ...
      <DialogContent className="sm:max-w-[500px]">
        ...
        <div className="space-y-4 py-4">
          <div className="space-y-2">
            <Label>Date Range (Status Date)</Label>
          ...
          <div className="space-y-2">
            <Label>Author Count</Label>
            <Select value={localFilters.authorCount} onValueChange={(value) => setLocalFilters({ ...localFilters, authorCount: value })}>
              <SelectTrigger><SelectValue /></SelectTrigger>
              <SelectContent>
