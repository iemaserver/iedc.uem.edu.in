...
export function StatusGraph({ copyrights, title = "Visibility Distribution", description = "Copyrights by visibility" }: StatusGraphProps) {
    ...
    <Card className="flex flex-col bg-gradient-to-br from-violet-50/50 via-white to-purple-50/50 dark:from-violet-950/20 dark:via-background dark:to-purple-950/20 border-violet-200/50 dark:border-violet-800/30">
      ...
      <CardContent className="p-2">
        {totalCount === 0 ? (
          ...
          <ChartContainer config={chartConfig} className="w-full h-[200px] sm:h-[250px] lg:h-[160px] bg-gradient-to-br from-violet-50/80 to-purple-50/80 dark:from-violet-950/40 dark:to-purple-950/40 rounded-lg">
      ...
      <CardFooter><div className="flex w-full items-center justify-center text-xs sm:text-sm text-muted-foreground">Public vs Private copyrights</div></CardFooter>
    </Card>
  );
}
