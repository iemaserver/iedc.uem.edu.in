...
import { exportCopyrightsExcel } from "@/lib/csvExport";
...
export function CopyrightsTable() {
  ...
  const fetchCopyrightsData = async () => {
    setIsLoading(true);
    try {
      const result = await fetchCopyrights(filters);
  ...
  const toggleSelectAll = () => {
    const allPageIds = copyrights.map((c) => c.id);
  ...
  if (isLoading && copyrights.length === 0) {
    return (
          ...
          <div className="flex flex-col sm:flex-row sm:justify-between sm:items-start gap-4">
            <div className="space-y-2">
              ...
              <CardDescription className="text-sm sm:text-base">
                Manage your copyright entries and intellectual property
              </CardDescription>
            </div>
            <div className="flex flex-col sm:flex-row gap-2">
              ...
              <Button
                onClick={() =>
                  exportCopyrightsExcel(copyrights, "copyrights.xlsx")
                }
                variant="outline"
                ...
                <TableRow className="hover:bg-transparent">
                  <TableHead className="w-12">
                    <Checkbox
                      checked={
                        copyrights.length > 0 &&
                        copyrights.every((c) => selectedIds.includes(c.id))
                      }
                  ...
                  <TableRow>
                    ...
                    >
                      {activeFilterCount > 0
                        ...
                        : "No copyrights found. Create your first one!"}
                    </TableCell>
                  </TableRow>
                ) : (
