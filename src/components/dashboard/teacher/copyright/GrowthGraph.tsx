...
const chartConfig = {
  count: { label: "Copyrights", color: "hsl(260, 75%, 55%)" },
} satisfies ChartConfig;

export function GrowthGraph({
  copyrights,
  title = "Copyrights Growth",
  description = "Monthly cumulative growth of copyrights",
  monthsToShow = 6,
}: GrowthGraphProps) {
        ...
        <div className="flex w-full items-start gap-2 text-xs sm:text-sm">
          <div className="grid gap-1 sm:gap-2">
            ...
            <div className="text-muted-foreground flex items-center gap-2 leading-none">
              Total: {totalCopyrights} copyrights
            </div>
          </div>
        </div>
      </CardFooter>
