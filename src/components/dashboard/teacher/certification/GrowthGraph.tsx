...
export function GrowthGraph({ 
  ...
  description = "Monthly cumulative growth of certifications",
  monthsToShow = 6 
}: GrowthGraphProps) {
  ...
  const totalCertifications = chartData[chartData.length - 1]?.cumulative || 0;
              ...
              <ChartTooltip
                ...
                content={<ChartTooltipContent 
                  ...
                  formatter={(value, name) => [
                    ...
                    name === "cumulative" ? "Total Certifications" : "New This Month"
                  ]}
                />}
              />
              <Area
