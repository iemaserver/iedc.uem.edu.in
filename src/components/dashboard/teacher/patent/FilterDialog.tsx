...
export function FilterDialog({ filters, onFiltersChange, visibilityOptions = ["public", "private"] }: FilterDialogProps) {
  ...
  const handleClear = () => {
    const cleared = { dateRange: { from: "", to: "" }, visibility: "all", inventorCount: "all", patentStatus: "all" };
      ...
      <DialogContent className="sm:max-w-[500px]">
        ...
        <div className="space-y-4 py-4">
          ...
          <div className="space-y-2">
            ...
            <Select value={localFilters.patentStatus} onValueChange={(value) => setLocalFilters({ ...localFilters, patentStatus: value })}>
