...
export function GrowthGraph({ 
  data, 
  title = "Ongoing Projects Growth", 
  description = "Monthly cumulative growth of ongoing projects",
  monthsToShow = 6 
}: GrowthGraphProps) {
  ...
  const totalProjects = chartData[chartData.length - 1]?.cumulative || 0;
            ...
            <ChartTooltip
              ...
              content={<ChartTooltipContent 
                ...
                formatter={(value, name) => [
                  ...
                  name === "cumulative" ? "Total Projects" : "New This Month"
                ]}
              />}
            />
            <Area
        ...
        <div className="flex w-full items-start gap-2 text-xs sm:text-sm">
          <div className="grid gap-1 sm:gap-2">
            ...
            <div className="text-muted-foreground flex items-center gap-2 leading-none">
              Total: {totalProjects} ongoing projects
            </div>
          </div>
        </div>
      </CardFooter>
