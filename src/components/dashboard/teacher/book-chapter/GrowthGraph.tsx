...
export function GrowthGraph({ 
  data, 
  title = "Book Chapters Growth", 
  description = "Monthly cumulative growth of book chapters",
  monthsToShow = 6 
}: GrowthGraphProps) {
  ...
  const totalChapters = chartData[chartData.length - 1]?.cumulative || 0;
            ...
            <ChartTooltip
              ...
              content={<ChartTooltipContent 
                ...
                formatter={(value, name) => [
                  ...
                  name === "cumulative" ? "Total Chapters" : "New This Month"
                ]}
              />}
            />
            <Area
        ...
        <div className="flex w-full items-start gap-2 text-xs sm:text-sm">
          <div className="grid gap-1 sm:gap-2">
            ...
            <div className="text-muted-foreground flex items-center gap-2 leading-none">
              Total: {totalChapters} book chapters
            </div>
          </div>
        </div>
      </CardFooter>
