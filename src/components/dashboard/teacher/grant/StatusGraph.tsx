...
export function StatusGraph({ grants, title = "Visibility Distribution", description = "Grants by visibility" }: StatusGraphProps) {
    ...
    <Card className="flex flex-col bg-gradient-to-br from-indigo-50/50 via-white to-blue-50/50 dark:from-indigo-950/20 dark:via-background dark:to-blue-950/20 border-indigo-200/50 dark:border-indigo-800/30">
      ...
      <CardContent className="p-2">
        {totalCount === 0 ? (
          ...
          <ChartContainer config={chartConfig} className="w-full h-[200px] sm:h-[250px] lg:h-[160px] bg-gradient-to-br from-indigo-50/80 to-blue-50/80 dark:from-indigo-950/40 dark:to-blue-950/40 rounded-lg">
      ...
      <CardFooter><div className="flex w-full items-center justify-center text-xs sm:text-sm text-muted-foreground">Public vs Private grants</div></CardFooter>
    </Card>
  );
}
