...
export function FilterDialog({ filters, onFiltersChange, visibilityOptions = ["public", "private"] }: FilterDialogProps) {
  ...
  const handleClear = () => {
    const cleared = { dateRange: { from: "", to: "" }, visibility: "all", investigatorCount: "all", status: "all" };
  ...
  const activeCount = [
    ...
    localFilters.investigatorCount !== "all",
  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="sm:max-w-[500px]">
        <DialogHeader>
          <DialogTitle>Filter Grants</DialogTitle>
        </DialogHeader>
        <div className="space-y-4 py-4">
          ...
          <div className="space-y-2">
            <Label>Investigator Count</Label>
            <Select value={localFilters.investigatorCount} onValueChange={(value) => setLocalFilters({ ...localFilters, investigatorCount: value })}>
              <SelectTrigger><SelectValue /></SelectTrigger>
              <SelectContent>
