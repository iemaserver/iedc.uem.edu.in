...
export function GrowthGraph({ 
  ...
  const { chartData, trend } = useMemo(() => {
   ...
   return (
     <Card className="flex flex-col bg-gradient-to-br from-blue-50/50 via-white to-indigo-50">
       <CardHeader className="pb-2">
         <CardTitle className="text-lg md:text-xl text-[var(--first-color)]">{title}</CardTitle>
         <CardDescription className="text-xs md:text-sm text-[var(--first-color)]/70">{description}</CardDescription>
       </CardHeader>
