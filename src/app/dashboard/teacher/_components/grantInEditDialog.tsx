...
const formSchema = z.object({
  ...
  grantAmount: z.number().positive().optional().nullable(),
  utilizedAmount: z.number().optional().nullable(),
  ...
  const onSubmit = async (formData: any) => {
    ...
    try {
      const payload = {
        ...
        projectPI: formData.projectPI?.trim() || null,
        projectCoPI: formData.projectCoPI?.trim() || null,
        status: formData.status?.trim() || null,
        appliedAt: formData.appliedAt?.trim() || null,
        grantedAt: formData.grantedAt?.trim() || null,
        publication: formData.publication?.trim() || null,
        publicationDetails: formData.publicationDetails?.trim() || null,
